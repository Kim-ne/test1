...
if (isset($_GET['tu'], $_GET['den'])) {
   ...
   /* <div class="float-left mt-3 mx-2">
            1x2=1 <br>
            1x2=1 <br>
            1x2=1<br>
            1x2=1<br>
    ...
    if ($flag) {
        ...
        for ($i = $_GET['tu']; $i <= $_GET['den']; $i ++ ){
            ...
            $kq .= '<div class="float-left mt-3 mx-2">';
            // xử lý tiếp ruột
                for ( $k = 1; $k <=10; $k ++){
                    $kq .= $i .' x ' .$k.' = ' .($i * $k).'<br>';
                } 
...
<body>
    <form class="container">
        <h4 class="text-center">Xuất bảng cửu chương</h4>
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="">Từ</label>
                    <input type="text" class="form-control <?php echo ($msgt ?? '') ?>" name="tu" id=""
                        aria-describedby="helpId" placeholder="" style="width: 90%"
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="">Đến</label>
                    <input type="text" class="form-control  <?php echo ($msgd ?? '') ?>" name="den" id=""
                        aria-describedby="helpId" placeholder="" style="width: 90%"
                        value="<?php echo $_GET['den'] ?? '' ?>">
